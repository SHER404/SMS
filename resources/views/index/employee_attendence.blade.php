...
<?php
                                  $attendence=App\Http\Controllers\EmployeesAttendenceController::getAttendence();
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                                    <div class="widget widget-one_hybrid  widget-referral" style="background-color: rebeccapurple;">
                                        ...
                                        <div class="text-end m-2">
                                                    <p class="w-value text-light">
                                                         ...
                                                         <form action="/employee-attendence" method="Post">
                                                             @csrf
                                                            <a href="javascript:{}" class="btn btn-outline-light" onclick="this.closest('form').submit();">Employee Attendence</a>
                                                         </form>
                                                    </p>
