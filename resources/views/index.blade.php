...
@section('content')
                           ...
                           <script>window.location = "/school-visitors/create";</script>
                           @endif
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row layout-top-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          ...
                          <!-- classes end -->
                          <!-- fee defaulters -->
                          @if(auth()->user()->hasDirectPermission('dashboard-fee-defaulter'))
                            @include('index.fee_defaulter')
                          @endif
                          <!-- fee defaulters end -->
                          <!-- Sections  -->
                          ...
                          @endif
                           <!-- employee attendence -->
                          @if(auth()->user()->hasDirectPermission('dashboard-employee-attendence'))
                            @include('index.employee_attendence')
                          @endif
                        </div>
                        <div class="row widget-statistic">
