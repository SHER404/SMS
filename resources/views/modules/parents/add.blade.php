                                    ...
                                    <form action="{{ route('parents.store') }}" method="POST">
                                        @csrf 
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control" name="father_cnic" id="father_cnic" placeholder="Father CNIC">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control" name="father_office_tel" id="father_office_tel" placeholder="Father Office Tel">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        <label for="mother_office_tel">Mother Office Tel</label>
                                                        <input type="text" class="form-control" name="mother_office_tel" id="mother_office_tel" placeholder="Mother Office Tel">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        <label for="father_office_address">Father/Guardian Office Address</label>
                                                        <input type="text" class="form-control" name="father_office_address" id="father_office_address" placeholder="Father Office Address">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        <label for="mother_office_address">Mother Office Address</label>
                                                        <input type="text" class="form-control" name="mother_office_address" id="mother_office_address" placeholder="Mother Office Address">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control" name="father_mobile" id="father_mobile" placeholder="Father Mobile">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-4">
                                                        <label for="mother_mobile">Mother Mobile</label>
                                                        <input type="text" class="form-control" name="mother_mobile" id="mother_mobile" placeholder="Mother Mobile">
                                                    </div>
                                                </div>
                                            </div>
